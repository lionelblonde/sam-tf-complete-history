...
def learn(comm,
    ...
    d_trainable_vars = d.trainable_vars
    ...
    d_adam = MpiAdam(d_trainable_vars)
    ...
    while True:
        ...
        for minibatch in d_feeder.get_feed(batch_size=d_batch_size):
            ...
            *new_losses, grad = d.lossandgrad(ob_agent, ac_agent, ob_expert, ac_expert)
            # Use the retrieved local gradient to make an Adam optimization update
            d_adam.update(grad, d_lr)
